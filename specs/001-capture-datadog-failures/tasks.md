...
- [ ] T021 [P] [US2] Implement Firestore query helper to read and filter `FailureCapture` documents with support for time range, severity, and agent filters in `src/api/capture_queue.py`.
