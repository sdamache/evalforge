...
structured output for eval test drafts.
"""
...
from src.generators.eval_tests.models import get_eval_test_draft_response_schema
...
class GeminiClient:
    ...
    def __init__(self, config: GeminiConfig):
        self.config = config
        self._client = None
        self._response_schema = get_eval_test_draft_response_schema()
    ...
    def generate_eval_test_draft(self, prompt: str) -> GeminiResponse:
